...
const FONT_STACKS = {
  ...
  condensed: `"Arial Narrow","Bahnschrift Condensed","Segoe UI",Arial,sans-serif`,
  geometric: `"Trebuchet MS","Aptos Display","Segoe UI",Arial,sans-serif`,
};
...
const THEMES = {
  ...
  /* ------------------------------------------------------------------ */
  'editorial-ink': {
    label: 'Editorial Ink - white magazine style with serif headlines',
    mode: 'light',
    fonts: { heading: FONT_STACKS.editorial, body: FONT_STACKS.humanist },
    radius: { card: '2px', cardLg: '4px', cardXl: '6px' },
    background: {
      type: 'none',
      stage: `linear-gradient(90deg,rgba(17,24,39,.045) 1px,transparent 1px),
    linear-gradient(180deg,rgba(17,24,39,.035) 1px,transparent 1px),
    linear-gradient(135deg,#fffdf8 0%,#f7f3ea 58%,#ebe7dc 100%)`,
      page: '#d9d2c4',
    },
    particles: { from: [80, 80, 80], to: [20, 20, 20] },
    colors: {
      textHi: '#171717', textMid: '#404040', textLow: '#737373',
      cardBg: '#fffaf0', cardBorder: '#171717',
      chipBg: '#ffffff', badgeBg: '#171717', badgeBorder: '#171717',
      rule: '#171717', ruleSoft: 'rgba(23,23,23,.18)', connector: 'rgba(23,23,23,.45)',
      glow: '23,23,23',
    },
    accents: {
      a1: slot('#111827', '#111827', ['#111827', '#374151'], 'rgba(17,24,39,.08)'),
      a2: slot('#2563eb', '#2563eb', ['#1d4ed8', '#60a5fa'], 'rgba(37,99,235,.12)'),
      a3: slot('#dc2626', '#dc2626', ['#b91c1c', '#f87171'], 'rgba(220,38,38,.12)'),
      a4: slot('#ca8a04', '#ca8a04', ['#a16207', '#facc15'], 'rgba(202,138,4,.14)'),
    },
    light: {
      bg: '#fffdf8', panel: '#ece6d8', card: '#ffffff', cardBorder: '#171717',
      header: '#171717', title: '#111827', text: '#262626', textSoft: '#525252',
      footText: '#737373', footRule: '#171717',
    },
    semantic: SEMANTIC,
  },
  /* ------------------------------------------------------------------ */
  'aurora-purple': {
    label: 'Aurora Purple - vivid violet, magenta and cyan product style',
    mode: 'dark',
    fonts: { heading: FONT_STACKS.geometric, body: FONT_STACKS.humanist },
    radius: { card: '26px', cardLg: '32px', cardXl: '38px' },
    background: {
      type: 'orbs',
      stage: `radial-gradient(820px 420px at 14% 18%, rgba(244,114,182,.34), transparent 68%),
    radial-gradient(760px 380px at 88% 20%, rgba(34,211,238,.25), transparent 70%),
    radial-gradient(650px 420px at 52% 96%, rgba(167,139,250,.28), transparent 72%),
    linear-gradient(145deg,#1b0738 0%,#23094d 42%,#07152f 100%)`,
      page: '#10021f',
    },
    particles: { from: [244, 114, 182], to: [34, 211, 238] },
    colors: {
      textHi: '#fff7ff', textMid: '#ead8ff', textLow: '#b9a2d8',
      cardBg: 'linear-gradient(155deg,rgba(255,255,255,.15),rgba(255,255,255,.055))',
      cardBorder: 'rgba(255,255,255,.28)',
      chipBg: 'rgba(255,255,255,.12)', badgeBg: 'rgba(255,255,255,.16)', badgeBorder: 'rgba(255,255,255,.28)',
      rule: 'rgba(255,255,255,.22)', ruleSoft: 'rgba(255,255,255,.16)', connector: 'rgba(255,255,255,.38)',
      glow: '244,114,182',
    },
    accents: {
      a1: slot('#f472b6', '#f9a8d4', ['#db2777', '#f472b6'], 'rgba(244,114,182,.22)'),
      a2: slot('#22d3ee', '#67e8f9', ['#0891b2', '#22d3ee'], 'rgba(34,211,238,.18)'),
      a3: slot('#a78bfa', '#c4b5fd', ['#7c3aed', '#a78bfa'], 'rgba(167,139,250,.22)'),
      a4: slot('#facc15', '#fde047', ['#ca8a04', '#facc15'], 'rgba(250,204,21,.16)'),
    },
    light: {
      bg: '#faf5ff', panel: '#efe6ff', card: '#ffffff', cardBorder: '#ddd0f2',
      header: '#2e1065', title: '#7e22ce', text: '#3b255d', textSoft: '#684985',
      footText: '#8970a4', footRule: '#ded0ee',
    },
    semantic: SEMANTIC,
  },
  /* ------------------------------------------------------------------ */
  'mint-lab': {
    label: 'Mint Lab - soft light product lab with rounded shapes',
    mode: 'light',
    fonts: { heading: FONT_STACKS.geometric, body: FONT_STACKS.humanist },
    radius: { card: '24px', cardLg: '30px', cardXl: '36px' },
    background: {
      type: 'grid',
      stage: `radial-gradient(900px 380px at 12% 12%, rgba(45,212,191,.22), transparent 70%),
    radial-gradient(760px 360px at 88% 0%, rgba(59,130,246,.16), transparent 68%),
    linear-gradient(135deg,#f8fffb 0%,#eafaf4 55%,#e7f0ff 100%)`,
      page: '#dcefe8',
    },
    particles: { from: [45, 212, 191], to: [59, 130, 246] },
    colors: {
      textHi: '#07342f', textMid: '#24514b', textLow: '#6b8a84',
      cardBg: 'rgba(255,255,255,.82)', cardBorder: 'rgba(13,148,136,.22)',
      chipBg: '#f0fdfa', badgeBg: '#ecfeff', badgeBorder: 'rgba(13,148,136,.22)',
      rule: 'rgba(13,148,136,.24)', ruleSoft: 'rgba(13,148,136,.15)', connector: 'rgba(13,148,136,.34)',
      glow: '45,212,191',
    },
    accents: {
      a1: slot('#0d9488', '#0d9488', ['#0f766e', '#2dd4bf'], 'rgba(13,148,136,.12)'),
      a2: slot('#2563eb', '#2563eb', ['#1d4ed8', '#60a5fa'], 'rgba(37,99,235,.12)'),
      a3: slot('#65a30d', '#65a30d', ['#4d7c0f', '#a3e635'], 'rgba(101,163,13,.12)'),
      a4: slot('#c026d3', '#c026d3', ['#a21caf', '#f0abfc'], 'rgba(192,38,211,.12)'),
    },
    light: {
      bg: '#f8fffb', panel: '#e4f4ee', card: '#ffffff', cardBorder: '#cde8df',
      header: '#07342f', title: '#0d9488', text: '#16433d', textSoft: '#4f6f69',
      footText: '#7a908c', footRule: '#cce5dd',
    },
    semantic: SEMANTIC,
  },
  /* ------------------------------------------------------------------ */
  'mono-signal': {
    label: 'Mono Signal - black, white and electric green technical style',
    mode: 'dark',
    fonts: { heading: FONT_STACKS.condensed, body: FONT_STACKS.mono },
    radius: { card: '0px', cardLg: '0px', cardXl: '0px' },
    background: {
      type: 'grid',
      stage: `linear-gradient(90deg,rgba(52,211,153,.12) 1px,transparent 1px),
    linear-gradient(180deg,rgba(52,211,153,.10) 1px,transparent 1px),
    linear-gradient(155deg,#030303 0%,#06130d 56%,#000000 100%)`,
      page: '#000000',
    },
    particles: { from: [52, 211, 153], to: [163, 230, 53] },
    colors: {
      textHi: '#f8fafc', textMid: '#cbd5e1', textLow: '#94a3b8',
      cardBg: 'rgba(0,0,0,.72)', cardBorder: '#34d399',
      chipBg: 'rgba(52,211,153,.12)', badgeBg: '#34d399', badgeBorder: '#34d399',
      rule: 'rgba(52,211,153,.55)', ruleSoft: 'rgba(52,211,153,.22)', connector: 'rgba(52,211,153,.60)',
      glow: '52,211,153',
    },
    accents: {
      a1: slot('#34d399', '#86efac', ['#16a34a', '#34d399'], 'rgba(52,211,153,.16)'),
      a2: slot('#a3e635', '#bef264', ['#65a30d', '#a3e635'], 'rgba(163,230,53,.16)'),
      a3: slot('#22d3ee', '#67e8f9', ['#0891b2', '#22d3ee'], 'rgba(34,211,238,.14)'),
      a4: slot('#f43f5e', '#fb7185', ['#be123c', '#f43f5e'], 'rgba(244,63,94,.14)'),
    },
    light: {
      bg: '#f8fafc', panel: '#e2e8f0', card: '#ffffff', cardBorder: '#111827',
      header: '#111827', title: '#047857', text: '#111827', textSoft: '#475569',
      footText: '#64748b', footRule: '#111827',
    },
    semantic: SEMANTIC,
  },
};
